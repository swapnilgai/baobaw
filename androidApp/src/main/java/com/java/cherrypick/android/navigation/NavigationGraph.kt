...
import com.java.cherrypick.android.feature.location.UserLocationScreen
...
fun NavigationGraph(navController: NavHostController) {
    NavHost(navController = navController, startDestination = Screens.Login.route) {
        ...
        composable(route = Screens.UserLocation.route){
            UserLocationScreen(locationViewModel = get(), navController = navController)
        }
    }
}
